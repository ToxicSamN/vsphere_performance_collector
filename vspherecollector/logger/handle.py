...
class Logger:
    ...
    def __init__(self, log_file='/var/log/vcenter_collector/collect_metrics.log',
                 error_log_file='/var/log/vcenter_collector/collect_metrics_err.log',
    ...
    def get_logger(self, name):
        ...
        dh.setFormatter(self.formatter)
        dfh = logging.handlers.RotatingFileHandler("{}_debug.log".format(self.log_file.replace('.log', '')),
                                                   mode='a',
                                                   maxBytes=self.logsize*10,
