...
class Logger:
    """
    Custom logging class that fits with how I prefer to log.
    ...
    def __init__(self, log_file='/var/log/statsd.log',
                 error_log_file='/var/log/statsd_err.log',
    ...
    def get_logger(self, name):
        ...
        dfh = logging.StreamHandler(sys.stdout)
